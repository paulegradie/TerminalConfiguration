...
$temp = New-ItemProperty 'HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\User Shell Folders' Personal -Value $currentDirectory -Type ExpandString -Force

$CurrentUserCurrentHost = ($profile | Select-Object *).CurrentUserCurrentHost
